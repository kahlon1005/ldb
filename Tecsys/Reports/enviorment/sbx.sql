...
Declare	@target_host_name varchar(100) = 'tswmsea.sbox.bcldb.com' 
Declare @bullzip_device_name varchar(20) = 'Bullzip';
Declare	@target_instance_name varchar(100) = 'tswmsea.sbox.bcldb.com_sbx_94x'

USE [sbx_94x_m]
--select * from md_mq_generic;
update md_mq_generic set instance_name = @target_instance_name;
