...
SET IDENTITY_INSERT [dev_94x_w_arch].[dbo].[manifest_a] OFF	
...
END CATCH  
SET IDENTITY_INSERT [dev_94x_w_arch].[dbo].[bol_a] OFF	
SET IDENTITY_INSERT [dev_94x_w_arch].[dbo].[cpack_a] ON	
...
END CATCH  
SET IDENTITY_INSERT [dev_94x_w_arch].[dbo].[cpack_a] OFF	
SET IDENTITY_INSERT [dev_94x_w_arch].[dbo].[mpack_a] ON	
...
END CATCH  
SET IDENTITY_INSERT [dev_94x_w_arch].[dbo].[mpack_a] OFF	
...
SET IDENTITY_INSERT [dev_94x_w_arch].[dbo].[it_a] ON	
...
END CATCH  
SET IDENTITY_INSERT [dev_94x_w_arch].[dbo].[it_a] OFF	
...
SET IDENTITY_INSERT [dev_94x_w_arch].[dbo].[md_attachment_a] ON	
...
END CATCH  
SET IDENTITY_INSERT [dev_94x_w_arch].[dbo].[md_attachment] OFF	
