...
(mpack_id, mpack_order_seq, whse_code, cust_oid, cases, bottles) AS
SELECT q2.mpack_id, q2.mpack_order_seq, q2.whse_code, q2.cust_oid, FLOOR(q2.liquor_cases) cases, FLOOR(q2.liquor_units) bottles  
FROM (
	SELECT mpack_order.mpack_id, mpack_order.mpack_order_seq, q3.whse_code, q3.cust_oid, SUM(q3.liquor_cases) liquor_cases, SUM(q3.liquor_units) liquor_units FROM (
		SELECT q1.whse_code, q1.ob_oid, q1.cust_oid, q1.cont, q1.liquor_cases,  q1.liquor_units
		FROM(
