...
/****** Object:  View [dbo].[ob_ord_summ_ldb]    Script Date: 2/27/2019 11:01:11 AM ******/
SET ANSI_NULLS ON
GO
...
SELECT q3.whse_code,  q3.ob_oid, RIGHT(q3.ob_oid,4) bignum, om_f.wave, om_f.shipment,
	...
	ISNULL(sh_f.pick_cmp,'N') pick_cmp
FROM (
...
LEFT JOIN shipunit_f sh_f ON sh_f.whse_code = q3.whse_code AND sh_f.cont = q3.cont;
