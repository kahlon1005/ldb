DROP VIEW IF EXISTS [dbo].[cpack_order_line_ldb]
GO

CREATE VIEW [dbo].[cpack_order_line_ldb]
AS
SELECT cpack.cpack_id, cpack_order.cpack_order_seq, q2.whse_code, q2.ob_oid, q2.cont, q2.line_seq, q2.sku, q2.sku_desc, q2.non_liquor, ISNULL(q2.btl_cont, ' ') btl_cont, CAST(q2.volume as decimal(14,3)) volume, CAST(q2.pack_size as Integer) pack_size, q2.cases, CAST(q2.bottles as Integer) bottles, CAST(q2.non_liquor_pieces as Integer) non_liquor_pieces, ISNULL(q2.cust_oid, ' ') cust_oid  
FROM (
